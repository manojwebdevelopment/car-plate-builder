...
//       {/* Main Navigation */}
//       <nav className="navbar navbar-expand-lg shadow-sm" style={{ backgroundColor: '#a4161a' }}>
//         <div className="container">
//           {/* Brand */}
//           <Link className="navbar-brand fw-bold fs-3" to="/">
//             <span style={{ color: '#ffc107' }}>Abhishek</span>
//             <span style={{ color: '#000' }}>Plates</span>
//           </Link>
...
// src/components/Navbar/AuthNavbar.jsx - Minimal Theme Changes
import React, { useState, useEffect } from 'react';
import { Link, useNavigate } from 'react-router-dom';
import { useAuth } from '../../context/AuthContext';
import { useCart } from '../../context/CartContext';
...
const AuthNavbar = () => {
  ...
  return (
    <>
      ...
      {/* Main Navigation */}
      <nav className="navbar navbar-expand-lg navbar-theme shadow-sm">
        <div className="container">
          {/* Brand */}
          <Link className="navbar-brand navbar-brand-theme fw-bold fs-3" to="/">
            <span className="brand-primary">PlateForge</span>
          </Link>

          {/* Mobile Toggle */}
          <button 
            className="navbar-toggler navbar-toggler-theme border-0" 
            type="button" 
            data-bs-toggle="collapse" 
            data-bs-target="#navbarNav"
          >
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            ...
            <ul className="navbar-nav me-auto">
              <li className="nav-item">
                <Link className="nav-link nav-link-theme fw-semibold px-3" to="/">Home</Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link nav-link-theme fw-semibold px-3" to="/platebuilder">Build Plate</Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link nav-link-theme fw-semibold px-3" to="/about">About</Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link nav-link-theme fw-semibold px-3" to="/contact">Contact</Link>
              </li>
            </ul>
            ...
            <ul className="navbar-nav ms-auto align-items-center">
              ...
              <li className="nav-item me-3">
                <button 
                  className="btn btn-outline-warning btn-cart-theme position-relative"
                  onClick={handleCartClick}
                  disabled={cartLoading}
                >
                  {cartLoading ? (
              ...
              {isAuthenticated ? (
                ...
                <li className="nav-item dropdown">
                  <button 
                    className="btn btn-link nav-link dropdown-toggle d-flex align-items-center text-decoration-none user-btn-theme"
                    onClick={() => setShowUserDropdown(!showUserDropdown)}
                    style={{ border: 'none' }}
                  >
                    <div className="d-flex align-items-center">
                      <div 
                        className="rounded-circle user-avatar-theme d-flex align-items-center justify-content-center me-2"
                        style={{ width: '32px', height: '32px' }}
                      >
                ...
                <>
                  <li className="nav-item me-2">
                    <Link 
                      to="/login" 
                      className="btn btn-outline-dark btn-login-theme fw-semibold px-3"
                    >
                      Login
                    </Link>
                  </li>
                  <li className="nav-item">
                    <Link 
                      to="/register" 
                      className="btn btn-warning btn-signup-theme fw-semibold px-3"
                    >
                      Sign Up
                    </Link>
                  </li>
