...
//         if (textWithoutSpaces.length > 6) {
//             return 'Registration is too long- max 7 characters.';
//         }
//         return '';
//     };

//     // NEW: Handle plate text change with validation
//     const handlePlateTextChange = (value) => {
//         setPlateText(value.toUpperCase());
//     };

//     // UPDATED: Handle toggle changes and reset quantities
...
//             if ((wantFrontPlate && frontQuantity === 0) && (wantRearPlate && rearQuantity === 0)) {
//                 alert('Please select at least one front or rear plate.');
//                 return;
//             }
...
//                                                 />
//                                                 <label className="form-check-label fw-bold" htmlFor="frontPlateToggle">
...
//                                                 />
//                                                 <label className="form-check-label fw-bold" htmlFor="rearPlateToggle">
//                                                     I want a rear plate
//                                                 </label>
//                                             </div>
//                                         </div>
...
//                                     <button
//                                         className="btn btn-outline-warning"
//                                         onClick={() => setFrontQuantity(Math.max(1, frontQuantity - 1))}
//                                     >
//                                         <ChevronLeft size={10} />
//                                     </button>
//                                     <input
...
//                                         className="form-control text-center fw-bold border-warning"
//                                         value={frontQuantity}
//                                         onChange={(e) => setFrontQuantity(Math.max(1, parseInt(e.target.value) || 1))}
//                                         min="1" max="10"
//                                     />
//                                     <button
//                                         className="btn btn-outline-warning"
...
//                                     <button
//                                         className="btn btn-outline-warning"
//                                         onClick={() => setRearQuantity(Math.max(1, rearQuantity - 1))}
//                                     >
//                                         <ChevronLeft size={10} />
//                                     </button>
//                                     <input
...
//                                         className="form-control text-center fw-bold border-warning"
//                                         value={rearQuantity}
//                                         onChange={(e) => setRearQuantity(Math.max(1, parseInt(e.target.value) || 1))}
//                                         min="1" max="10"
//                                     />
//                                     <button
//                                         className="btn btn-outline-warning"
...
//                             ) : (
//                                 <div className="text-center py-5">
//                                     <h5 className="text-muted">Please select front or rear plate to see preview</h5>
//                                 </div>
//                             )}
...
//                             <button 
//                                 className={`btn btn-lg fw-bold w-100 text-white mb-3 ${
//                                     isLegalCheckboxChecked && totalQuantity > 0 ? 'btn-success' : 'btn-secondary'
//                                 }`}
//                                 onClick={handleAddToCart}
//                                 disabled={!isLegalCheckboxChecked || totalQuantity === 0}
//                                 style={{
//                                     opacity: (isLegalCheckboxChecked && totalQuantity > 0) ? 1 : 0.6,
//                                     cursor: (isLegalCheckboxChecked && totalQuantity > 0) ? 'pointer' : 'not-allowed',
//                                     transition: 'all 0.3s ease'
//                                 }}
//                             >
//                                 <ShoppingCart className="me-2" size={10} />
                                ...
                                {wantFrontPlate && (
                                    <div className={`col-${wantRearPlate ? '6' : '12'}`}>
                                        <button
                                            onClick={() => setPreviewType('front')}
                                            className={`btn w-100 fw-bold ${
                                                previewType === 'front' ? 'btn-warning text-dark' : 'btn-outline-secondary bg-light text-dark'
                                            }`}
                                ...
                                {wantRearPlate && (
                                    <div className={`col-${wantFrontPlate ? '6' : '12'}`}>
                                        <button
                                            onClick={() => setPreviewType('rear')}
                                            className={`btn w-100 fw-bold ${
                                                previewType === 'rear' ? 'btn-warning text-dark' : 'btn-outline-secondary bg-light text-dark'
                                            }`}
                                            style={{ borderRadius: 0 , border: 'none'}}
                                        >
