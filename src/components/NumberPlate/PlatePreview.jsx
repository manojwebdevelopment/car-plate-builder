...
//   // Text positioning calculation with border adjustment
...
//             {/* Main text - NOW PROPERLY ELEVATED for ALL borders */}
//             <Suspense fallback={null}>
//               <Text3D
//                 font={fontUrl}
//                 size={fontSize * 1.05}
//                 height={plateThickness * 1.6}
//                 position={textPosition} // Uses the elevated Z-position for all borders
//                 bevelEnabled={true}
//                 bevelThickness={plateThickness * 0.05}
//                 bevelSize={plateThickness * 0.02}
//                 curveSegments={16}
...
//     const yPosition = -0.4; // Perfect vertical center of the plate
...
// border edgs dark back side code 
// import React, { useEffect, useRef, Suspense } from "react";
// import { Canvas } from "@react-three/fiber";
// import { OrbitControls, Text3D } from "@react-three/drei";
// import * as THREE from "three";
...
//     // Y-AXIS CENTERING - CHANGED FROM -0.28 TO 0
//     const yPosition = 0; // Perfect vertical center of the plate
...
//             {/* PLATE BORDER - Dark gray border around the plate edge (like reference image) */}
//             <mesh position={[0, 0, -0.001]} receiveShadow={false} castShadow={false}>
//               <primitive
//                 object={createRoundedBoxGeometry(
//                   dimensions.width + 0.04, // Slightly larger for visible border
//                   dimensions.height + 0.04, // Slightly larger for visible border
//                   dimensions.depth * 0.6, // Thinner depth for border effect only
//                   0.09 // Same rounded corners as main plate
//                 )}
//               />
//               <meshStandardMaterial
//                 color="#3a3a3a" // Dark gray border like reference image
//                 metalness={0.2}
//                 roughness={0.3}
//                 clearcoat={0.4}
//                 clearcoatRoughness={0.1}
